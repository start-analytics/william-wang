...
const amplifyDirectories = [join(process.cwd(), ".amplify-hosting"), join(process.cwd(), ".amplify-hosting", "static"), join(process.cwd(), ".amplify-hosting", "static", "_next"), join(process.cwd(), ".amplify-hosting", "compute"), join(process.cwd(), ".amplify-hosting", "compute", "default"), join(process.cwd(), ".amplify-hosting", "compute", "default", "node_modules")];
